...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        #da_relu,grads['W2'],grads['b2']=affine_backward(dscore,c2)
        #da=relu_backward(da_relu,c1_relu)
        #dx,grads['W1'],grads['b1']=affine_backward(da,c1)
        #grads['W1']/=N
        #grads['b1']/=N
        #grads['W2']/=N
        #grads['b2']/=N
        ...
        dev[range(N), y] -= 1
        grad_a_relu, grads['W2'], grads['b2'] = affine_backward(dev, c2)
        grads['W2']/= N
        grads['W2'] += self.reg*self.params['W2']
        grads['b2']/= N

        grad_a = relu_backward(grad_a_relu, c1_relu)

        grads_x, grads['W1'], grads['b1'] = affine_backward(grad_a, c1)
        grads['W1']/= N
        grads['W1'] += self.reg*self.params['W1']
        grads['b1']/= N
